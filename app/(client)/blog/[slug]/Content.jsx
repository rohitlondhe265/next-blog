...
export default async function Page () {
    return (
        <main className="px-2 lg:px-12 bg-gray-100 space-y-3" style={{ flex: "5" }}>
            ...
            <img className='w-full pt-3 aspect-video object-cover object-center' src="/images/img3.png" alt="post image" />

            <article class="prose max-w-none text-justify lg:px-6">
